...
namespace Datalayer.Repository
{
    public class DropCreate : DropCreateDatabaseIfModelChanges<Datacontext>
    {
        protected override void Seed(Datacontext context)
        {
            ...
            var Dicken = new User { Firstname = "Timmy", Lastname = "Rullstol", Email = "timmy@hotmail.com", Password = "timmy1", Age = 45, About = "Åker rullstol", Gender = "Woman", Searchable = true, PictureURL = "https://vignette.wikia.nocookie.net/southpark/images/0/0b/62a.jpg/revision/latest/scale-to-width-down/310?cb=20100827140143" };
